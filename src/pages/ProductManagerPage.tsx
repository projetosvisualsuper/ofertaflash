        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {registeredProducts.map(product => (
              <details key={product.id} className="bg-gray-50 border rounded-lg shadow-sm hover:shadow-md transition-shadow group">
                <summary className="p-3 flex gap-3 items-start cursor-pointer">
                  ...
                  <button onClick={() => handleDeleteProduct(product.id, product.name)} className="text-gray-400 hover:text-red-500" title="Remover"><Trash2 size={16} /></button>
                </summary>
            ...
            {registeredProducts.length === 0 && !loading && (
