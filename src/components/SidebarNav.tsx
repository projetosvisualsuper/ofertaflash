...
import { LayoutTemplate, Monitor, Clapperboard, Image, Settings, Zap, Database, Building, LogOut, Users, Lock, UserCircle, Shield, BarChart3, ListOrdered } from 'lucide-react';
...
const MODULES: { id: string; name: string; icon: React.ElementType; description: string; permission: Permission }[] = [
  ...
  { id: 'orders', name: 'Gerenciamento de Pedidos', icon: ListOrdered, description: 'Gerencie pedidos de criação e tarefas.', permission: 'manage_orders' }, // NOVO MÓDULO
